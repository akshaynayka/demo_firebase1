...
class ServiceProviderDashboardWidget extends StatefulWidget {
  const ServiceProviderDashboardWidget({required this.userData, Key? key})
      : super(key: key);
  final User userData;
  @override
    ...
    final List<Map<String, dynamic>> dataList = [
      ...
      // },
      {
        ...
        'stream': firebaseInstance
            .collection(apiCalls)
            .where('serviceProviderId', isEqualTo: _serviceProviderId)
      ...
      {
        'title': appTitleAwaitingTechnicianCallRequests,
        'icon': Icons.timer_sharp,
        'stream': firebaseInstance
